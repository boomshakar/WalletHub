 ...
 * * The content that user inputs will preserve its whitespaces
 * and linebreaks when printed under the [review_content] property
 * * It should not allow rendering of html tags to prevent a security
 * vulnerability (keep the inner text however)
 * * If the user enters a link in the content (ex : https://wallethub.com)
 * it should become an anchor element when printed in the page
 */
